	...
	function lancerLeJeu () {
		...
		$("#svgloadchap1scene1").svg({
	        onLoad: function(){
	            ...
	            svg.load('./images/thomas-manteau.svg', { addTo: true,  changeSize: false});        
	    }, settings: {}} );  
	}
			...
			setTimeout(function () {
				...
				$("#svgloadchap1scene2").svg({
			        onLoad: function(){
			            ...
			            svg2.load('./images/thomas.svg', { addTo: true,  changeSize: false});        
			    }, settings: {}} ); 
			}, 500);
			...
			setTimeout(function () {
				...
				$("#svgloadchap1scene4").svg({
			        onLoad: function(){
			            ...
			            svg3.load('./images/thomas-manteau-2.svg', { addTo: true,  changeSize: false});        
			    }, settings: {}} ); 
			}, 500);
