...
/* REPLIQUES BUREAU DE LEOPOLD */
	...
	var tabRepliqueTableau = ["C'est un tableau en liège, pour punaiser des documents. Il y a déjà quelques post-it vierges dessus. Je pourrais m'en servir si jamais j'en ai besoin."];
