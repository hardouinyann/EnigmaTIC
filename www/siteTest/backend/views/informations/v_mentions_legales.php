  <style>
    ...
    @media only screen and (min-width: 100px) and (max-width: 1400px)  {
       .page{  height:70%; margin-top: 2%!important; }
       h2 {  padding-top: 5%; }
    }
  ...
  <section class="page">
    ...
    Crédits : les mentions légales ont été générées et offertes par Subdelirium <a target="_blank" href="http://www.subdelirium.com/competences/creation-de-sites-web/creation-de-site-internet-en-charente/creation-de-site-internet-cognac/">création de site web Cognac</a></p>
    ...
    <p>Le site <a href="http://http://www.enigma-tic.fr" title="L'équipe d'Enigma'TIC - http://www.enigma-tic.fr/">http://www.enigma-tic.fr/</a> a pour objet de divertir les utilisateurs, tout en leur permettant de découvrir les évolutions majeures des interfaces graphiques, de façon ludique et interactive. Ce site a pour unique but d'informer et de divertir les utilisateurs, avec du contenu accessible en ligne gratuitement. Les utilisateurs peuvent accéder à ce site, et jouer au jeu en ligne qui y est proposé à tout moment, et où ils veulent, du moment qu'ils ont accès à un ordinateur avec Internet.</p>
    <p>Ce projet a été réalisé par un groupe de sept étudiants du Master « Produits et Services Multimédia » dans le cadre des projets « Rhizome ». L’équipe est constituée d’Axelle Simon, de Brittany Boiteux, de Yann Hardouin, de Fei Qi, de Benoît Muller, de Justine Jouffroy et de Vincent Lepigeon. Ce projet a été entièrement conçu et réalisé par ce groupe d’étudiant, à l’université de Franche-Comté (UFR STGI) de Montbéliard. Ce site se présente sous la forme d’un jeu d’aventure en ligne auquel n’importe quel utilisateur peut participer. L’utilisateur doit ainsi aider, et suivre le personnage principal du jeu, afin de mener l’enquête pour retrouver son grand-père dont il n’a plus de nouvelles depuis plusieurs jours.</p>
    <h3>4. Limitations contractuelles sur les données techniques.</h3>
    <p>Le site utilise les technologies HTML5, CSS3, PHP et JavaScript (et notamment le framework JQuery). Le site Internet ne pourra être tenu responsable de dommages matériels liés à l’utilisation du site. De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel récent, ne contenant pas de virus et avec un navigateur de dernière génération mis-à-jour.</p>
    ...
    <p>En France, les données personnelles sont protégées par la loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août 2004, l'article L. 226-13 du Code pénal et la Directive Européenne du 24 octobre 1995. A l'occasion de l'utilisation du site <a href="http://http://www.enigma-tic.fr" title="L'équipe d'Enigma'TIC - http://www.enigma-tic.fr/">http://www.enigma-tic.fr/</a>, peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site, le fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
    <p> En tout état de cause L'équipe d'Enigma'TIC ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site <a href="http://http://www.enigma-tic.fr" title="L'équipe d'Enigma'TIC - http://www.enigma-tic.fr/">http://www.enigma-tic.fr/</a>. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site Enigma'TIC l’obligation ou non de fournir ces informations.</p>
    <p>Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification et d’opposition aux données personnelles le concernant, en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.</p>
    <p>Aucune information personnelle de l'utilisateur du site <a href="http://http://www.enigma-tic.fr" title="L'équipe d'Enigma'TIC - http://www.enigma-tic.fr/">http://www.enigma-tic.fr/</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Les bases de données sont protégées par les dispositions de la loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars 1996 relative à la protection juridique des bases de données.</p>
    ...
    <p>- <b>Sous Internet Explorer</b> : onglet outil (pictogramme en forme de rouage en haut a droite) / options internet. Cliquez sur Confidentialité et choisissez Bloquer tous les cookies. Validez sur Ok.<br/>- <b>Sous Firefox</b> : en haut de la fenêtre du navigateur, cliquez sur le bouton Firefox, puis aller dans l'onglet Options. Cliquer sur l'onglet Vie privée. Paramétrez les Règles de conservation sur :  utiliser les paramètres personnalisés pour l'historique. Enfin décochez-la pour  désactiver les cookies.<br/>- <b>Sous Safari</b> : Cliquez en haut à droite du navigateur sur le pictogramme de menu (symbolisé par un rouage). Sélectionnez Paramètres. Cliquez sur Afficher les paramètres avancés. Dans la section "Confidentialité", cliquez sur Paramètres de contenu. Dans la section "Cookies", vous pouvez bloquer les cookies.<br/>- <b>Sous Google Chrome</b> : Cliquez en haut à droite du navigateur sur le pictogramme de menu (symbolisé par trois lignes horizontales). Sélectionnez Paramètres. Cliquez sur Afficher les paramètres avancés. Dans la section "Confidentialité", cliquez sur préférences.  Dans l'onglet "Confidentialité", vous pouvez bloquer les cookies.</p>
