...
(function mapGen(b, c, e, a, m) {
    ...
    function character(a, b) {
        ...
        f >= c && mapGen("#canvasLaby", c, e, 0, m + 1)
    }
    ...
    for (cr_l = 0; cr_l < e; cr_l++) {
        ...
        //Supprimer aléatoirement certains carré
        for (i = 0; i < c; i++) {
...
//Objet, nbColonne, nbLigne, nbStep, nbComplete
("#canvasLaby", 30, 30, 0, 0);